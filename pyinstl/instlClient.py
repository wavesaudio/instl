...
class InstlClient(InstlInstanceBase):
    ...
    def calculate_install_items(self):
        ...
        self.items_table.db.lock_table("index_item_t") #prevent us from insert bugs, locks db so we don't update it in a wrong phase
    ...
    def calculate_main_install_items(self):
        ...
        # this is a second time we run this commadn since it's possoble more items were added
    ...
    def resolve_special_build_in_iids(self, iids: List[str]):
        ...
        if len(found_special_build_in_iids) > 0: #usualy cases for debuggin,
