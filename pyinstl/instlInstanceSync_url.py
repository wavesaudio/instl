...
class InstlInstanceSync_url(InstlInstanceSync):
    ...
    def create_sync_instructions(self, installState):
        ...
        self.create_download_instructions_old()
    ...
    def create_download_instructions_old(self):
        self.instlObj.batch_accum.set_current_section('sync')
        ...
        for need_item in file_list + dir_list:
            self.create_download_instructions_for_item_old(need_item)
    ...
    def create_download_instructions_for_item_old(self, item, path_so_far=None):
        ...
        if item.isSymlink():
            ...
            for sub_item in file_list + dir_list:
                self.create_download_instructions_for_item_old(sub_item, path_so_far)
            path_so_far.pop()
