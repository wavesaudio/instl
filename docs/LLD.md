...
| `DOWNLOAD_CURL_STALL_DETECTION` | `yes` | kill switch; `DOWNLOAD_CURL_SPEED_LIMIT 1` bytes/s, `DOWNLOAD_CURL_SPEED_TIME 120` s (curl exits 28 on stall); `DOWNLOAD_STALL_WATCHDOG_SECONDS 180` (poller observability backstop, 0 disables) |
