...
class CurlWithInternalParallel(PythonBatchCommandBase, kwargs_defaults={
    ...
    def __call__(self, *args, **kwargs):
        ...
        transfer = _download_transfer().CurlTransfer(
            ...
            total_files_to_download=self.total_files_to_download,
            previously_downloaded_files=self.previously_downloaded_files,
            total_bytes_to_download=self.total_bytes_to_download,
            fallback_config_file_path=self.fallback_config_file_path,
            fallback_exit_codes=self.fallback_exit_codes,
