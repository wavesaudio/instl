...
with Stage(r"assign", prog_num=8):  # 0m:0.000s
...
with PythonBatchRuntime(r"doit", prog_num=9):  # 0m:17.255s
    with Stage(r"begin", prog_num=10):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre_doit", prog_num=11):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=12):  # 0m:17.254s
        with Stage(r"CLEAN_PREVIOUS_INSTL...", prog_num=13):  # 0m:0.010s
            # --- Begin CLEAN_PREVIOUS_INSTL CLEAN_PREVIOUS_INSTL
            with RmDir(r"build_instl/temp_build_dir", prog_num=14) as rm_dir_001_14:  # 0m:0.001s
                rm_dir_001_14()
            with MakeDirs(r"build_instl/temp_build_dir", prog_num=15) as make_dirs_002_15:  # 0m:0.000s
                make_dirs_002_15()
            with RmDir(r"$(INSTL_SOURCE_DIR/build)", prog_num=16) as rm_dir_003_16:  # 0m:0.000s
                rm_dir_003_16()
            with RmDir(r"$(INSTL_SOURCE_DIR/dist)", prog_num=17) as rm_dir_004_17:  # 0m:0.000s
                rm_dir_004_17()
            with RmDir(r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle", prog_num=18) as rm_dir_005_18:  # 0m:0.000s
                rm_dir_005_18()
            with MakeDirs(r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools", prog_num=19) as make_dirs_006_19:  # 0m:0.008s
                make_dirs_006_19()
            # --- End CLEAN_PREVIOUS_INSTL CLEAN_PREVIOUS_INSTL
        with Stage(r"CREATE_PIP_FREEZE_FILE...", prog_num=20):  # 0m:0.244s
        ...
        with Stage(r"CREATE_COMPILE_INFO_FILE...", prog_num=22):  # 0m:0.013s
            # --- Begin CREATE_COMPILE_INFO_FILE CREATE_COMPILE_INFO_FILE
            with Exec(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/build_instl/create-compile-info.py", args=[r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../instl/defaults/compile-info.yaml"], prog_num=23) as exec_008_23:  # 0m:0.013s
                exec_008_23()
            # --- End CREATE_COMPILE_INFO_FILE CREATE_COMPILE_INFO_FILE
        with Stage(r"PRINT_PIP_PACKAGES...", prog_num=24):  # 0m:0.233s
            # --- Begin PRINT_PIP_PACKAGES PRINT_PIP_PACKAGES
            print("List installed packages:")
            with ShellCommand(r'"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../instl/venv/bin/python3.12" -m pip list', prog_num=25, stderr_means_err=False) as shell_command_009_25:  # 0m:0.233s
                shell_command_009_25()
            # --- End PRINT_PIP_PACKAGES PRINT_PIP_PACKAGES
        with Stage(r"COMPILE_INSTL...", prog_num=26):  # 0m:16.087s
            # --- Begin COMPILE_INSTL COMPILE_INSTL
            with ShellCommand(r'"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../instl/venv/bin/python3.12" "/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/build_instl/build_instl.py" --configuration Debug --instl-folder "/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../instl" --target-folder "build_instl/temp_build_dir"', prog_num=27) as shell_command_010_27:  # 0m:16.087s
                shell_command_010_27()
            # --- End COMPILE_INSTL COMPILE_INSTL
        with Stage(r"CREATE_BUNDLE...", prog_num=28):  # 0m:0.115s
            # --- Begin CREATE_BUNDLE CREATE_BUNDLE
            with CopyDirContentsToDir(r"build_instl/temp_build_dir/instl", r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/MacOS", copy_stat=True, prog_num=29) as copy_dir_contents_to_dir_011_29:  # 0m:0.095s
                copy_dir_contents_to_dir_011_29()
            with CopyDirContentsToDir(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/instl/defaults", r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/Resources/defaults", copy_stat=True, prog_num=30) as copy_dir_contents_to_dir_012_30:  # 0m:0.015s
                copy_dir_contents_to_dir_012_30()
            with RmDir(r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/MacOS/_internal/Python.framework", prog_num=31) as rm_dir_013_31:  # 0m:0.004s
                rm_dir_013_31()
            with Glober(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../../../Products/Debug/Tools/instl.bundle/Contents/MacOS//_internal/*.dist-info", RmFile, r"path", prog_num=32) as glober_014_32:  # 0m:0.001s
                glober_014_32()
            with Glober(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../../../Products/Debug/Tools/instl.bundle/Contents/MacOS//_internal/setuptools/_vendor/*.dist-info", RmFile, r"path", prog_num=33) as glober_015_33:  # 0m:0.000s
                glober_015_33()
            # --- End CREATE_BUNDLE CREATE_BUNDLE
        with Stage(r"ADD_INFO_FILES...", prog_num=34):  # 0m:0.010s
            # --- Begin ADD_INFO_FILES ADD_INFO_FILES
            with CopyFileToFile(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/build_instl/Info.plist", r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/Info.plist", prog_num=35) as copy_file_to_file_016_35:  # 0m:0.007s
                copy_file_to_file_016_35()
            with Chmod(path=r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../../../Products/Debug/Tools/instl.bundle/Contents/Info.plist", mode="a+rw", prog_num=36) as chmod_017_36:  # 0m:0.000s
                chmod_017_36()
            with ReadConfigVarValueFromTextFile(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../../../XcodeBuildProducts/__AUTO_BUILD_NUMBER__.txt", r"BUILD_NUMBER", ignore_all_errors=True, prog_num=37) as read_config_var_value_from_text_file_018_37:  # 0m:0.000s
                read_config_var_value_from_text_file_018_37()
            with ResolveConfigVarsInFile(r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/Info.plist", config_files=[], prog_num=38) as resolve_config_vars_in_file_019_38:  # 0m:0.001s
                resolve_config_vars_in_file_019_38()
            # --- End ADD_INFO_FILES ADD_INFO_FILES
        with Stage(r"ADD_PYBATCH_HELP_FILE...", prog_num=39):  # 0m:0.534s
            # --- Begin ADD_PYBATCH_HELP_FILE ADD_PYBATCH_HELP_FILE
            with MakeDirs(r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/Resources/help", prog_num=40) as make_dirs_020_40:  # 0m:0.000s
                make_dirs_020_40()
            with ShellCommand(r"python3.12 /Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../instl/instl help pybatch-verbose > /Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/../../../../Products/Debug/Tools/instl.bundle/Contents/Resources/help/pybatch_help.txt", prog_num=41) as shell_command_021_41:  # 0m:0.531s
                shell_command_021_41()
            with CopyFileToDir(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/instl/help/helpHelper.py", r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/Resources/help", prog_num=42) as copy_file_to_dir_022_42:  # 0m:0.002s
                copy_file_to_dir_022_42()
            # --- End ADD_PYBATCH_HELP_FILE ADD_PYBATCH_HELP_FILE
        with Stage(r"ADD_ICON_TO_INSTL_BUNDLE...", prog_num=43):  # 0m:0.008s
            # --- Begin ADD_ICON_TO_INSTL_BUNDLE ADD_ICON_TO_INSTL_BUNDLE
            with CopyFileToFile(r"/Users/vitaliz/source/Central/ProAudio/XPlatform/CopyProtect/wls/Central/build_instl/instl.icns", r"/Users/vitaliz/source/Central/ProAudio/Products/Debug/Tools/instl.bundle/Contents/Resources/instl.icns", prog_num=44) as copy_file_to_file_023_44:  # 0m:0.007s
                copy_file_to_file_023_44()
            # --- End ADD_ICON_TO_INSTL_BUNDLE ADD_ICON_TO_INSTL_BUNDLE
        with Stage(r"sign instl...", prog_num=45):  # 0m:0.000s
            # --- Begin SIGN sign instl
            Print(r"not on build machine - not signing", prog_num=45)()
            # --- End SIGN sign instl
    with Stage(r"post_doit", prog_num=46):  # 0m:0.000s
        print("Done Doing it")
